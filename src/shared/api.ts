...
export const anthropicDefaultModelId: AnthropicModelId = "claude-4-sonnet-20250522"
...
export const openRouterDefaultModelId = "anthropic/claude-4-sonnet" // will always exist in openRouterModels
